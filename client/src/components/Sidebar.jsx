...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed lg:relative z-50 lg:z-20 w-64 bg-white border-r border-slate-200 flex flex-col h-full flex-shrink-0 
      ...
      `}>
        ...
        <button 
          onClick={onClose}
          className="lg:hidden absolute top-6 right-6 w-10 h-10 flex items-center justify-center rounded-xl bg-slate-50 text-slate-500 hover:bg-slate-100 transition-colors"
        >
